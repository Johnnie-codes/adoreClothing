...
const articles = ref([
  ...
  {
    id: 6,
    title: "Wholesale Services Now Available",
    excerpt: "Kenema_Pharmacies_Enterprise is proud to announce the launch of our Wholesale Division, dedicated to serving healthcare providers, clinics, hospitals, and retail pharmacies across the region.",
    content: [
      "Kenema_Pharmacies_Enterprise is proud to announce the launch of our Wholesale Division, dedicated to serving healthcare providers, clinics, hospitals, and retail pharmacies across the region. With our commitment to reliability, affordability, and quality, we now offer a wide range of pharmaceutical and medical products in bulk—ensuring that communities have consistent access to the medicines they need",
      "✅ What We Offer:",
      "#Competitive bulk pricing",
      "#Broad selection of genuine, high-quality medicines",
      "#Fast and reliable delivery",
      "#Dedicated account managers",
      "#Easy ordering and invoicing options",
